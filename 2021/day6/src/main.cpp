...
size_t Part1( const std::string& aFileName )
{
	auto lanternfishPopulation = CreateFromFile<CLanternfishPopulation>( aFileName );
	lanternfishPopulation.PassDay( 80 );
	return lanternfishPopulation.CountPopulation();
}

size_t Part2( const std::string& aFileName )
{
	auto lanternfishPopulation = CreateFromFile<CLanternfishPopulation>( aFileName );
	lanternfishPopulation.PassDay( 256 );
	return lanternfishPopulation.CountPopulation();
}
