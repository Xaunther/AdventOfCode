...
uint32_t CountMatching2( Messages const& messages, std::list<std::string> const& possibilities_x, std::list<std::string> const& possibilities_y )
{
    uint32_t result = 0;
    for( auto message : messages )
...
int main()
{
    ...
    auto result2 = CountMatching2( messages, possibilities_x, possibilities_y );
